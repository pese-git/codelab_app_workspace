...
abstract final class AppTheme {
  ...
  static fluent.FluentThemeData get fluentLight =>
      buildAppTheme(brightness: Brightness.light);

  /// Dark FluentUI theme data
  static fluent.FluentThemeData get fluentDark =>
